...
function showTask(taskId) {
    var taskDescriptions = {
        ...
        taskPro4: 'Pagina Web de $800 Recomendada para promociones y varias sucursales, incluye fondo, producto, precio, botones, idiomas, otras paginas, moderna, catalogos, animaciones,mas informacion, base de datos, comentarios de usuarios e informacion para llenar, promociones en tiempo real etc.  <a href="/PaginasWeb/Prototipo4/index.html" target="_blank">Ver más detalles</a>',
        taskPro5: 'Pagina Web de $900 Recomendada para tiendas en linea, promociones y varias sucursales, incluye fondo, productos, precio, botones, idiomas, otras paginas, moderna, catalogos, animaciones, mas informacion, base de datos, comentarios de usuarios e informacion para llenar, promociones en tiempo real, filtro de busqueda para usuarios, sistema logico de compras etc. <a href="/PaginasWeb/Prototipo5/index.html" target="_blank">Ver más detalles</a>',
        taskPro6: 'Pagina Web de $1000 E commerce, Recomendada para tiendas en linea, promociones y varias sucursales, incluye fondo, productos, precio, botones, idiomas, otras paginas, moderna, catalogos, animaciones, mas informacion, base de datos, comentarios de usuarios e informacion para llenar, promociones en tiempo real, filtro de busqueda para usuarios, sistema logico de compras etc.  <a href="/PaginasWeb/Prototipo6/index.html" target="_blank">Ver más detalles</a>',
        taskPro7: 'Pagina Web de $2000 Ideal para menu de restaurante, promociones y varias sucursales, incluye fondo, productos, precio, botones, idiomas, otras paginas, moderna, catalogos, animaciones, mas informacion, base de datos, comentarios de usuarios e informacion para llenar, promociones en tiempo real, filtro de busqueda para usuarios, sistema logico de compras, reserva de mesas, animaciones, React y personalizable etc.  <a href="/PaginasWeb/Prototipo7/index.html" target="_blank">Ver más detalles</a>',
        taskPro8: 'Pagina Web de $1200 Empresas, Pagina personalizable a tus necesidades. <a href="/PaginasWeb/Prototipo8/index.html" target="_blank">Ver más detalles</a>',
        taskPro9: 'Pagina Web de $500 para Curriculum, incluye fondo, Informacion, Otras paginas etc. <a href="/PaginasWeb/Prototipo9/RESUME-Source code/index.html" target="_blank">Ver más detalles</a>',
    };
